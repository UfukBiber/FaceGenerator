...
class GAN(tf.keras.Model):
    ...
    def SaveModel(self):
        self.generator.save_weights(os.path.join("DCGAN", "GENERATOR"))
        self.discriminator.save_weights(os.path.join("DCGAN", "DISCRIMINATOR"))
    
    def LoadModel(self):
        try:
            self.generator.load_weights(os.path.join("DCGAN", "GENERATOR"))
            self.discriminator.load_weights(os.path.join("DCGAN", "DISCRIMINATOR"))
